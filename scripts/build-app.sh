...
cp "$PROJECT_ROOT/scripts/Kistulentz.icns" "$APP_ROOT/Contents/Resources/Kistulentz.icns"
cp "$PROJECT_ROOT/AppSources/Kistulentz/Resources/KistulentzWordmark.png" "$APP_ROOT/Contents/Resources/KistulentzWordmark.png"
